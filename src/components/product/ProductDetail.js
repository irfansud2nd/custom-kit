...
export const ProductDetail = ({ img, heading, desc }) => {
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center bg-inherit border-b-2 border-solid border-custom-blue-light">
      <div className="hidden md:grid grid-cols-2 grid-rows-1 place-items-center w-full h-[80%] p-10">
        ...
        <img src={img} className="h-[80vh] rounded-md" />
      </div>
